...
class StoreIncomeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'to_cash_type_id' => 'required|integer|exists:cash_types,id', // Validasi untuk "to_cash_type_id" (integer dan harus ada di tabel cash_types)
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'to_cash_type_id.required' => 'The cash type field is required.',
            'to_cash_type_id.exists' => 'The selected cash type is invalid.',
        ];
    }
}
