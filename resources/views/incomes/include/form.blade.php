<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="account-type-id">{{ __('Dari Akun') }}</label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="from-cash-type-id">{{ __('Untuk Kas') }}</label>
            <select class="form-select @error('to_cash_type_id') is-invalid @enderror" name="to_cash_type_id" id="from-cash-type-id" class="form-control">
                <option value="" selected disabled>-- {{ __('Select Untuk Kas') }} --</option>
